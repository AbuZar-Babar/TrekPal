...
/**
 * Minimal top bar. Page-level titles live inside each page (PageHeader);
 * this only carries global utilities — search affordance, theme toggle, user chip.
 */
const Header = () => {
  ...
  return (
    <header className="portal-header">
      <div className="portal-header-inner" style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
