...
const ErrorPopup: React.FC<ErrorPopupProps> = ({ message, onClose }) => {
    ...
    return (
        ...
        >
            <div className="rounded-lg border border-[var(--border)] border-l-4 border-l-red-500 bg-[var(--surface)] p-4 shadow-2xl flex items-start gap-3 min-w-[300px] max-w-sm">
                ...
                <div className="flex-1">
                    <h3 className="text-sm font-bold text-[var(--text)]">Authentication Error</h3>
