    ...
    <PortalListItemTransition className="rounded-[18px] border border-gray-100 bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-md">
      <div className="flex justify-between items-start">
        <div className="flex gap-4 flex-1">
          {/* Avatar */}
          <div className="w-12 h-12 bg-gradient-to-br from-sky-400 to-blue-500 rounded-[14px] flex items-center justify-center text-white font-bold text-lg shadow-md flex-shrink-0">
            ...
            {vehicle.images && vehicle.images.length > 0 && (
              <div className="mb-3">
                <img
                  ...
                  alt={vehicle.make}
                  className="h-40 w-full rounded-[14px] border border-gray-100 object-cover"
                  onError={(e) => {
