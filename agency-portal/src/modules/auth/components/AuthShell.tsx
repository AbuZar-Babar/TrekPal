...
const AuthShell = ({
  ...
  const highlights = [
    'Track live trip requests and offer negotiations.',
    'Manage hotels, transport, and traveler commitments from one workspace.',
    'Login unlocks automatically after admin approval.',
  ];
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 text-[var(--text)] no-underline">
              ...
              <div>
                ...
                <div className="portal-brand-subtitle">Agency Portal</div>
              </div>
            </Link>
