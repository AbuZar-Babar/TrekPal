    ...
    return (
      <AnimatePresence>
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <motion.div
            className="relative z-10 w-full max-w-sm overflow-hidden rounded-[20px] border border-[var(--border,rgba(255,255,255,0.1))] bg-[var(--surface,#18181b)] p-6 shadow-2xl text-center"
          ...
          >
            ...
            <h3 className="mb-2 text-lg font-bold text-[var(--text,#ffffff)]">
              Cannot Delete
            </h3>
            <p className="mb-6 text-sm text-[var(--text-soft,#a1a1aa)] leading-relaxed">
              {error}
            </p>
            <button
              type="button"
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        {/* Modal Dialog */}
        <motion.div
          className="relative z-10 w-full max-w-sm overflow-hidden rounded-[20px] border border-[var(--border,rgba(255,255,255,0.1))] bg-[var(--surface,#18181b)] p-6 shadow-2xl"
        ...
        >
          ...
          {/* Title & Description */}
          <h3 className="mb-1.5 text-center text-lg font-bold text-[var(--text,#ffffff)]">
            {title}
          </h3>
          <div className="mb-6 text-center text-sm text-[var(--text-muted,#a1a1aa)]">
            {description}
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 rounded-[14px] border border-[var(--border,rgba(255,255,255,0.1))] bg-[var(--surface-high,rgba(255,255,255,0.05))] px-4 py-2.5 text-sm font-semibold text-[var(--text,#ffffff)] transition-all hover:bg-[var(--surface-strong,rgba(255,255,255,0.1))] disabled:opacity-50"
            >
              {cancelText}
            </button>
