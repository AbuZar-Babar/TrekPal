...
/**
 * Sidebar Navigation Component - Premium Design with SVG Icons
 */
const Sidebar = () => {
      ...
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400 tracking-wide">Agency Portal</p>
          </div>
        </div>
      </div>
