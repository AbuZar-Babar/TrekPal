...
const Header: React.FC = () => {
  ...
  return (
    <header className="portal-header">
      ...
      >
        <div className="hidden text-xs text-[var(--tp-text-soft)] lg:block">
          Hotel workspace
        </div>
        ...
        <div className="portal-header-actions">
          ...
          <div className="portal-user-card">
            ...
            <div className="hidden min-w-0 md:block">
              <div className="truncate text-xs font-semibold tracking-tight text-[var(--tp-text)]">
                {user?.name || 'Hotel'}
              </div>
              <div className="truncate text-[10px] text-[var(--tp-text-soft)]">
